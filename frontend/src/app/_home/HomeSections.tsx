  ...
  return (
    <section className="premium-texture-bg mx-auto max-w-full bg-[var(--color-cream)] px-5 py-[clamp(2.15rem,7vh,4.5rem)] md:px-8">
      <div className="mx-auto max-w-[1280px]">
        ...
        <style>{`@media(max-width:768px){.recent-paintings-scroll{display:flex!important;overflow-x:auto!important;overflow-y:hidden!important;scroll-snap-type:x mandatory!important;margin-left:-1rem!important;margin-right:-1rem!important;margin-top:-1.25rem!important;margin-bottom:-1.25rem!important;padding:1.5rem 0!important;gap:0!important;scrollbar-width:none!important;align-items:flex-start!important;scroll-padding:0 1rem!important}.recent-paintings-scroll::-webkit-scrollbar{display:none!important}.recent-paintings-item{flex:0 0 78%!important;min-width:0!important}.recent-paintings-item[data-snap-align="start"]{scroll-snap-align:start!important}.recent-paintings-item[data-snap-align="center"]{scroll-snap-align:center!important}.recent-paintings-spacer{display:block!important;flex:0 0 1rem!important;width:1rem!important}}`}</style>
